...
public class Site extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> lines = Files.readAllLines(Paths.get("D:\\Programm\\WEB\\logpas.txt"), StandardCharsets.UTF_8);
		...
		PrintWriter printWriter = new PrintWriter("D:\\Programm\\WEB\\logpas.txt", "UTF-8");
