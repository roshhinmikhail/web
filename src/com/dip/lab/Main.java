...
//		} else
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			printWriter = new PrintWriter(new OutputStreamWriter(new FileOutputStream("D:\\Programm\\WEB\\logpas.txt", true), "UTF-8"));
		}
		catch(FileNotFoundException e) {
			printWriter = new PrintWriter("D:\\Programm\\WEB\\logpas.txt", "UTF-8");
		}
